...
Information=read.table(paste("D://Dropbox//These//temperature//TCOMMON//each_year//CSV//TCOMMON_",Y,".csv",sep=""),sep = ",",header = T)
...
write.csv(Stations,file=paste("Station_exist_",Y,".csv",sep=""),quote=T,row.names=F)
